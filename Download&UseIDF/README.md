...
***Ví dụ:*** ``` F:\ThuHa\MADATEK\xiaozhi-esp32-2.2.3```
...
Để chạy file, cần setup version IDF, cổng nạp, COM, loại ESP32. Chọn ***Select curent ESP-IDF version*** để setup version idf phù hợp. Chọn ***Select Flash Method*** để setup cổng nạp phù hợp. Chọn ***Select Port to Use*** để setup cổng COM phù hợp. Chọn ***Espressif Device Target*** để setup bản ESP32 đang sử dụng.
